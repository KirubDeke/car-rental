      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <Link href="/home" className="flex items-center md:flex-1">
          <div className="flex items-center space-x-2 text-2xl font-semibold whitespace-nowrap">
            ...
            >
              Kirub<span className="text-accent"> Rental</span>
            </h2>
          </div>
        </Link>
        ...
        <div className="flex items-center md:flex-1 justify-end space-x-4">
          <button
            onClick={toggleTheme}
            className="p-2 rounded-full hover:bg-darkColor dark:hover:bg-whiteColor transition-colors"
          ...
          <ButtonOne
            ...
            className="hidden md:block px-4 py-2 bg-accent hover:bg-red-700 text-white rounded-md transition-colors duration-300 font-medium shadow-sm"
          >
            Sign In
          </ButtonOne>
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg hover:bg-darkColor dark:hover:bg-whiteColor focus:outline-none md:hidden"
        ...
        >
          <div className="bg-whiteColor dark:bg-darkColor rounded-lg shadow-lg mt-4 p-4 space-y-2">
            {navItems.map((item) => (
              <Link
                key={item.name}
                href={item.path}
                className={`block py-3 px-4 rounded-lg ${
                  isActiveLink(item.path)
                    ...
                    : "hover:bg-darkColor dark:hover:bg-whiteColor text-foreground"
            ...
            <div className="pt-2 border-t border-darkColor dark:border-whiteColor">
              <button
                onClick={toggleTheme}
                className="flex items-center w-full py-2.5 px-4 rounded-lg hover:bg-darkColor dark:hover:bg-whiteColor text-foreground font-medium transition-colors duration-200"
              >
                {theme === "light" ? (
                  <>
